...
public class PharmacistSupplierNamesTest {
    ...
    /* PH_SUPPLIER_NAMES_01
    Objective: Verify that the getSupplierNames method correctly retrieves supplier names and IDs.
    Input: None
           Pre-test state: Mocked DatabaseOperator returns predefined supplier data.
    Expected output: A HashMap mapping supplier IDs to names.
    Expected change: No database interaction.
     */
    @Test
    public void testGetSupplierNames_SuccessfulRetrieval() throws SQLException, ClassNotFoundException {
        ...
        HashMap<String, String> result = pharmacistInstance.getSupplierNames();

        assertNotNull(result, "The result should not be null when data is retrieved");
        assertEquals(1, result.size(), "The result should contain one supplier");
        assertEquals("PharmaCorp", result.get("sup0001"), "The supplier name should match");
    }

    /* PH_SUPPLIER_NAMES_02
    Objective: Verify that the getSupplierNames method handles an SQLException and returns an empty HashMap.
    Input: None
     ...
     */
    @Test
    public void testGetSupplierNames_ThrowsSQLException() throws SQLException, ClassNotFoundException {
    ...
    /* PH_SUPPLIER_NAMES_03
    Objective: Verify that the getSupplierNames method handles a case where no supplier data is returned.
    Input: None
     ...
     */
    @Test
    public void testGetSupplierNames_NoData() throws SQLException, ClassNotFoundException {
        ArrayList<ArrayList<String>> mockResult = new ArrayList<>();
        ArrayList<String> columns = new ArrayList<>();
        columns.add("supplier_id");
        columns.add("supplier_name");
