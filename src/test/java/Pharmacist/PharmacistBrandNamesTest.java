...
public class PharmacistBrandNamesTest {
    ...
    /* PH_BRAND_NAMES_01
    Objective: Verify that the getBrandNames method correctly retrieves brand names for a given generic name.
    Input: Name = "Acetaminophen"
           Pre-test state: Mocked DatabaseOperator returns predefined brand data.
    Expected output: An ArrayList containing column names and brand names.
    Expected change: No database interaction.
     */
    @Test
    public void testGetBrandNames_SuccessfulRetrieval() throws SQLException, ClassNotFoundException {
        ...
        ArrayList<ArrayList<String>> result = pharmacistInstance.getBrandNames("Acetaminophen");
        ...
        assertEquals("Panadol", result.get(1).get(0), "The brand name should match");
    }

    /* PH_BRAND_NAMES_02
    Objective: Verify that the getBrandNames method handles an SQLException and returns null.
    Input: Name = "Acetaminophen"
     ...
     */
    @Test
    public void testGetBrandNames_ThrowsSQLException() throws SQLException, ClassNotFoundException {
    ...
    /* PH_BRAND_NAMES_03
    Objective: Verify that the getBrandNames method handles a case where no brand data is returned.
    Input: Name = "Acetaminophen"
     ...
     */
    @Test
    public void testGetBrandNames_NoData() throws SQLException, ClassNotFoundException {
        ArrayList<ArrayList<String>> mockResult = new ArrayList<>();
        ArrayList<String> columns = new ArrayList<>();
        columns.add("brand_name");
        mockResult.add(columns);
        ...
        assertEquals("brand_name", result.get(0).get(0), "The column name should be brand_name");
    }
}