...
public class PharmacistDrugStockIDTest {
    ...
    /* PH_DRUG_STOCK_ID_01
    Objective: Verify that the getDrugStockID method correctly retrieves stock IDs and quantities for a given drug name.
    Input: drugName = "Panadol"
     ...
     */
    @Test
    public void testGetDrugStockID_SuccessfulRetrieval() throws SQLException, ClassNotFoundException {
        ...
        ArrayList<ArrayList<String>> result = pharmacistInstance.getDrugStockID("Panadol");
        ...
        assertEquals("450", result.get(1).get(1), "The remaining_quantity should match");
    }

    /* PH_DRUG_STOCK_ID_02
    Objective: Verify that the getDrugStockID method handles an SQLException and returns null.
    Input: drugName = "Panadol"
     ...
     */
    @Test
    public void testGetDrugStockID_ThrowsSQLException() throws SQLException, ClassNotFoundException {
    ...
    /* PH_DRUG_STOCK_ID_03
    Objective: Verify that the getDrugStockID method handles a case where no stock data is returned.
    Input: drugName = "Panadol"
     ...
     */
    @Test
    public void testGetDrugStockID_NoData() throws SQLException, ClassNotFoundException {
        ArrayList<ArrayList<String>> mockResult = new ArrayList<>();
        ArrayList<String> columns = new ArrayList<>();
        columns.add("stock_id");
        columns.add("remaining_quantity");
