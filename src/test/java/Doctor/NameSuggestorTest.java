...
public class NameSuggestorTest {
    ...
    public void testNameSuggestorMoreThanTwoWords() throws SQLException, ClassNotFoundException {
        String word = "John Doe Extra"; // Hơn 2 từ
    ...
    public void testNameSuggestorEmptyWord() throws SQLException, ClassNotFoundException {
        ...
        assertNull(result); // Kỳ vọng trả về null vì word rỗng
        verifyNoInteractions(dbOperator); // Không gọi customSelection vì word.length() < 1
    }
    @Test
    public void testNameSuggestorOnlyWhitespace() throws SQLException, ClassNotFoundException {
        ...
        assertNull(result); // Kỳ vọng trả về null vì word chỉ chứa khoảng trắng
