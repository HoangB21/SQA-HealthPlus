...
public class CashierGetProfileInfoTest {
    ...
    public void setUp() throws SQLException, ClassNotFoundException {
        ...
        // Mock dữ liệu sys_user để khởi tạo Cashier
    ...
    Input: None (uses userID = "hms0020u")
    ...
    public void testGetProfileInfo_SuccessfulRetrieval() throws SQLException, ClassNotFoundException {
        ...
        data.add("hms0020u");
        data.add("Kasun");
        data.add("Weerasekara");
        data.add("652489712V");
        data.add("No 26 Galla Estate Rajamawatha JaEla");
        data.add("0774523687");
        data.add("hms0020u");
        data.add("user020");
        data.add("cashier");
        ...
        assertEquals("Kasun", result.get("first_name"), "The first_name should match");
        assertEquals("Weerasekara", result.get("last_name"), "The last_name should match");
        ...
        assertEquals("No 26 Galla Estate Rajamawatha JaEla", result.get("address"), "The address should match");
        assertEquals("0774523687", result.get("mobile"), "The mobile should match");
    }
